...
import { createApplicationMenu, updateFileMenuForSelection } from './services/menu.service';
...
export default class App {
  ...
  private static initMainWindow() {
    ...
    ipcMain.on('update-menu-selection', (_event, hasSelection: boolean, isSingleFile: boolean) => {
    ...
    import('./events/electron.events').then((module) => {
